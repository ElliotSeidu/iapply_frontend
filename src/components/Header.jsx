                    ...
                    <div className="flex items-center gap-3 md:gap-4">
                        ...
                        {user && (
                            <button
                                ...
                                className="relative p-2 text-on-surface-variant hover:text-primary hover:bg-surface-container-high rounded-full transition-all cursor-pointer"
                            ...
                            >
                                ...
                                />
                                {unreadCount > 0 && (
                                    <span className="absolute top-1 right-1 w-2.5 h-2.5 bg-error rounded-full ring-2 ring-surface-container-lowest animate-pulse-subtle" />
                                )}
                            </button>
                        )}
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`h-full text-sm font-semibold transition-all flex items-center relative ${isActive ? "text-primary border-b-2 border-primary font-bold" : "text-on-surface-variant hover:text-primary"}`}
                                >
                                    {item.label}
                                </button>
                            );
