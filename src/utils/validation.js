...
export function validateUrl(url, required = false) {
    ...
    try {
        ...
        return {
            isValid: false,
            error: "Please enter a valid URL (e.g., https://company.com/jobs/123)",
        };
    }
}
 ...
 */
export function validateText(text, fieldName, options = {}) {
...
export function validateSalary(salary) {
    ...
    if (!hasNumber) {
        return {
            isValid: false,
            error: "Salary should include numbers (e.g. $120,000 - $150,000)",
        };
    }
    return {
        isValid: true,
